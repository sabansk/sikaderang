            ...
            <div class="card-body">
              <div class="tab-content p-0">
                ...
                <div class="chart tab-pane active" id="tab-gender" style="position: relative; height: 300px;">
                  ...
                  <div class="position-relative mb-4">
                    <canvas id="chart-gender" height="250"></canvas>
                  </div>
                  <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                ...
                <div class="chart tab-pane" id="tab-background" style="position: relative; height: 300px;">
                  <div class="position-relative mb-4">
                    <canvas id="chart-background" height="150"></canvas>
                  </div>
                  <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                      <i class="fas fa-square text-primary"></i> SMA/SMK/Se-Derajat
                    </span>
                    <span>
                      <i class="fas fa-square text-gray"></i> Mahasiswa
                    </span>
                  </div>
                </div>
              </div>
